...
YandexCheckout.prototype = {
   ...
   * @returns {Promise<Object>}
   */
  _createRefund: function(payload, idempotenceKey) {
    return utils.request.call(this, 'POST', 'refunds', payload, idempotenceKey);
  },
   ...
   * }
   */
  createRefund: function(payload, idempotenceKey) {
    var _self = this;
    return this._createRefund(payload, idempotenceKey).then(function(data) {
